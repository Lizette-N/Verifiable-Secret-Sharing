...
Sync = import_without_output("SynchronousVSS")
SECRET = 234
...
def run_correctness_test(
    ...
    """
    Run one synchronous VSS correctness scenario.
    ...
    with contextlib.redirect_stdout(io.StringIO()):
        ...
        t, q, n, delta, polynomial = Sync.variable_initialization(number_of_nodes)
        pp = Sync.PC.Setup(q)
        nodes = []
...
def run_all_correctness_tests():
    ...
    results = []
    print("\nRunning all synchronous correctness tests")
    print("=========================================")
